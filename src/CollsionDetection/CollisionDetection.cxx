...
{
    vtkNew<vtkSTLReader> tooth1;
    tooth1->SetFileName("D:\\DataRepo\\mesh\\86256671740230\\CaseData\\crown\\stl\\crown_7.stl");
    tooth1->Update();
    vtkNew<vtkSTLReader> tooth2;
    tooth2->SetFileName("D:\\DataRepo\\mesh\\86256671740230\\CaseData\\crown\\stl\\crown_8.stl");
    tooth2->Update();
    ...
    collide->SetInputConnection(0, tooth1->GetOutputPort());
    collide->SetTransform(0, transform0);
    collide->SetInputConnection(1, tooth2->GetOutputPort());
    ...
    if (contactMode == 0)
    {
        collide->SetCollisionModeToAllContacts(); //可以使用SetCollisionModeToAllContacts来获取全部
    }
    else if (contactMode == 1)
    {
        collide->SetCollisionModeToFirstContact(); //是获取第一次碰撞相交的块，
    }
    else
    {
...
void test()
{
    ...
    sphere0->SetPhiResolution(100);
    sphere0->SetThetaResolution(100);
